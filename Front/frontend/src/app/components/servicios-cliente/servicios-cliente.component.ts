...
//   listaHorasDisponibles: { hora: string }[] = [];
//   horaSeleccionada!: string;
...
//       // EXTRAER SOLO EL STRING DE LA HORA
//       this.listaHorasDisponibles = data.map(item => item.hora);

//       console.log("Horas procesadas:", this.listaHorasDisponibles);
//     },
//     error => {
...
finish() {
  ...
  const nombreTrabajador = this.trabajadorSeleccionado.usuario_idUsuario?.nombreUsuario || 'Sin nombre';
